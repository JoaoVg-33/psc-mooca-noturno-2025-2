...
if(op == 1){
    ...
    double operando3 = Double.parseDouble(JOptionPane.showInputDialog(null, "Qual é o terceiro operando"));
...
resultado = calc.soma(operando1,operando2);
    JOptionPane.showMessageDialog (null,"Opção invalida " + resultado);
